...
int main(int argc, char **argv)
{
	...
	EventRed ev;
	inT->SetBranchAddress("v_L_1_N", &ev.h.L_1_N.v); inT->SetBranchAddress("x_L_1_N", &ev.h.L_1_N.x); inT->SetBranchAddress("y_L_1_N", &ev.h.L_1_N.y);
	...
	inT->SetBranchAddress("v_R_1_N", &ev.h.R_1_N.v); inT->SetBranchAddress("x_R_1_N", &ev.h.R_1_N.x); inT->SetBranchAddress("y_R_1_N", &ev.h.R_1_N.y);
	...
	*/
	...
	TGraph *g_y_R_1_N_vs_x_R_1_N_al_sel = new TGraph(); g_y_R_1_N_vs_x_R_1_N_al_sel->SetName("g_y_R_1_N_vs_x_R_1_N_al_sel");
	...
	map<signed int, TGraph *> g_y_L_1_N_vs_x_L_1_N_sel, g_y_L_1_F_vs_x_L_1_F_sel;
	map<signed int, TGraph *> g_y_R_1_N_vs_x_R_1_N_sel, g_y_R_1_F_vs_x_R_1_F_sel;
	...
	*/
	...
	for (int ev_idx = 0; ev_idx < inT->GetEntries(); ++ev_idx)
	{
		...
		h_y_L_1_N_vs_x_L_1_N_al_nosel->Fill(h_al.L_1_N.x, h_al.L_1_N.y);
		h_y_L_1_F_vs_x_L_1_F_al_nosel->Fill(h_al.L_1_F.x, h_al.L_1_F.y);
		h_y_R_1_N_vs_x_R_1_N_al_nosel->Fill(h_al.R_1_N.x, h_al.R_1_N.y);
		...
		*/
		...
		if (detailsLevel >= 2)
		{
			if (g_w_vs_timestamp_sel.find(period) == g_w_vs_timestamp_sel.end())
			{
				...
				g_y_L_1_N_vs_x_L_1_N_sel[period] = new TGraph();
				g_y_L_1_F_vs_x_L_1_F_sel[period] = new TGraph();

				g_y_R_1_N_vs_x_R_1_N_sel[period] = new TGraph();
			...
			g_y_L_1_N_vs_x_L_1_N_sel[period]->SetPoint(idx, ev.h.L_1_N.x, ev.h.L_1_N.y);
			g_y_L_1_F_vs_x_L_1_F_sel[period]->SetPoint(idx, ev.h.L_1_F.x, ev.h.L_1_F.y);

			g_y_R_1_N_vs_x_R_1_N_sel[period]->SetPoint(idx, ev.h.R_1_N.x, ev.h.R_1_N.y);
		...
		h_y_L_1_N_vs_x_L_1_N_noal_sel->Fill(ev.h.L_1_N.x, ev.h.L_1_N.y);
		h_y_L_1_F_vs_x_L_1_F_noal_sel->Fill(ev.h.L_1_F.x, ev.h.L_1_F.y);
		h_y_R_1_N_vs_x_R_1_N_noal_sel->Fill(ev.h.R_1_N.x, ev.h.R_1_N.y);
		h_y_R_1_F_vs_x_R_1_F_noal_sel->Fill(ev.h.R_1_F.x, ev.h.R_1_F.y);

		h_y_L_1_N_vs_x_L_1_N_al_sel->Fill(h_al.L_1_N.x, h_al.L_1_N.y);
		h_y_L_1_F_vs_x_L_1_F_al_sel->Fill(h_al.L_1_F.x, h_al.L_1_F.y);
		h_y_R_1_N_vs_x_R_1_N_al_sel->Fill(h_al.R_1_N.x, h_al.R_1_N.y);
...

		{
			...
			if (idx < 100000)
			{
				g_y_L_1_N_vs_x_L_1_N_al_sel->SetPoint(idx, h_al.L_1_N.x, h_al.L_1_N.y);
				g_y_L_1_F_vs_x_L_1_F_al_sel->SetPoint(idx, h_al.L_1_F.x, h_al.L_1_F.y);
				g_y_R_1_N_vs_x_R_1_N_al_sel->SetPoint(idx, h_al.R_1_N.x, h_al.R_1_N.y);
	...
	*/
	...
	h_y_L_1_N_vs_x_L_1_N_al_nosel->Write();
	h_y_R_1_N_vs_x_R_1_N_al_nosel->Write();
	...
	h_y_L_1_N_vs_x_L_1_N_noal_sel->Write();
	h_y_R_1_N_vs_x_R_1_N_noal_sel->Write();
	...
	h_y_L_1_N_vs_x_L_1_N_al_sel->Write();
	h_y_R_1_N_vs_x_R_1_N_al_sel->Write();
	h_y_R_1_F_vs_x_R_1_F_al_sel->Write();

	g_y_L_1_F_vs_x_L_1_F_al_sel->Write();
	g_y_L_1_N_vs_x_L_1_N_al_sel->Write();
	g_y_R_1_N_vs_x_R_1_N_al_sel->Write();
	...
	for (map<signed int, TGraph *>::iterator pid = g_w_vs_timestamp_sel.begin(); pid != g_w_vs_timestamp_sel.end(); ++pid)
	{
		...
		g_y_L_1_N_vs_x_L_1_N_sel[period]->SetName("g_y_L_1_N_vs_x_L_1_N_sel"); g_y_L_1_N_vs_x_L_1_N_sel[period]->Write();
		g_y_L_1_F_vs_x_L_1_F_sel[period]->SetName("g_y_L_1_F_vs_x_L_1_F_sel"); g_y_L_1_F_vs_x_L_1_F_sel[period]->Write();

		g_y_R_1_N_vs_x_R_1_N_sel[period]->SetName("g_y_R_1_N_vs_x_R_1_N_sel"); g_y_R_1_N_vs_x_R_1_N_sel[period]->Write();
