...
void Init_base()
{
	...
	alSrc.cnst.a_L_1_F = 0E-3; alSrc.cnst.b_L_1_F = 2.7; alSrc.cnst.c_L_1_F = 0E-3;
	alSrc.cnst.a_L_1_N = 0E-3; alSrc.cnst.b_L_1_N = 3.1; alSrc.cnst.c_L_1_N = 0E-3;
                                                                       
	alSrc.cnst.a_R_1_N = 0E-3; alSrc.cnst.b_R_1_N = 3.3; alSrc.cnst.c_R_1_N = 0E-3;
	alSrc.cnst.a_R_1_F = 0E-3; alSrc.cnst.b_R_1_F = 2.3; alSrc.cnst.c_R_1_F = 0E-3;
	...
	anal.alignmentYRanges["L_1_N"] = Analysis::AlignmentYRange(-17., -5.8, 4.4, 17.);
	anal.alignmentYRanges["R_1_N"] = Analysis::AlignmentYRange(-17., -4.4, 5.2, 17.);
...
void Init_45b_56t()
{
	...
	anal.cut5_a = 0.144299; anal.cut5_c = -0.016; anal.cut5_si = 0.018;
	anal.cut6_a = 0.142346; anal.cut6_c = +0.001; anal.cut6_si = 0.018;
...
{
	// analysis settings
	anal.cut1_a = 1.; anal.cut1_c = +0.1E-6; anal.cut1_si = 40E-6;
	anal.cut2_a = 1.; anal.cut2_c = 40E-6; anal.cut2_si = 30E-6;

	anal.cut3_c = 0.0; anal.cut3_si = 0.14;
	anal.cut4_c = 0.0; anal.cut4_si = 0.14;

	anal.cut5_a = -0.13; anal.cut5_c = +0.27; anal.cut5_si = 0.030;
	anal.cut6_a = -0.13; anal.cut6_c = -0.20; anal.cut6_si = 0.030;
