...
Kinematics DoReconstruction(const HitData &h, const Environment & env)
{
	...
	k.th_y_L_N = - h.L_1_N.y / env.L_y_L_1_N;
  	k.th_y_L_F = - h.L_1_F.y / env.L_y_L_1_F;
  	k.th_y_L = (k.th_y_L_N + k.th_y_L_F) / 2.;
  	
	k.th_y_R_N = + h.R_1_N.y / env.L_y_R_1_N;
  	k.th_y_R_F = + h.R_1_F.y / env.L_y_R_1_F;
	...
	k.vtx_y_L = (- h.L_1_N.y * env.L_y_L_1_F + h.L_1_F.y * env.L_y_L_1_N) / D_y_L;

	double D_y_R = + env.v_y_R_1_N * env.L_y_R_1_F - env.v_y_R_1_F * env.L_y_R_1_N;
